...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[]) {
  ...
  //TODO: Add the points
  //points.emplace_back(5*WIN_WIDTH/6, WIN_HEIGHT*2/6); // This is redundand if we do 2 line loops
  points.emplace_back(1*WIN_WIDTH/6, WIN_HEIGHT*2/6);
  points.emplace_back(WIN_WIDTH/2, WIN_HEIGHT/6);
  points.emplace_back(5*WIN_WIDTH/6, WIN_HEIGHT*2/6);
  points.emplace_back(5*WIN_WIDTH/6,WIN_HEIGHT*5/6);
  points.emplace_back(1*WIN_WIDTH/6,WIN_HEIGHT*5/6);
  points.emplace_back(1*WIN_WIDTH/6,WIN_HEIGHT*2/6);
...
SDL_AppResult SDL_AppIterate(void *appstate) {
  ...
  // We can either render all lines, but then we'll need duplicate points

  // Or we can render 2 line loops
  line_loop(points,0,3);
  line_loop(points, 2,4);
